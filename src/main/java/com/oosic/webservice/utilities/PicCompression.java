...
public class PicCompression {
	...
	public static void incsurfMediumCompress(String path) {
		doCompress(path, 640, 640, 0.75f, "medium", true);
	}
	public static void incsurfLowCompress(String path) {
		doCompress(path, 128, 128, 0.5f, "low", true);
	}

	// 测试
	public static void main(String str[]) {
		System.out.println(PicCompression.doCompress("F:/421c9f25-6192-4e6a-b57f-8bf3a17d261f.jpg", 10, 10, 0,"small", true));
		System.out.print("ok...");
	}
