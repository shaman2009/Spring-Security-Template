...
public class MailUtil {
	 ...
	 */
	public static boolean sendEmail(Account userInfo, String toMail, String key) throws UnsupportedEncodingException {
	...
	public static boolean sendMailViaSpring(Account userInfo, String toMail, String key) throws Exception{
		String receiveUser = userInfo.getAlias();
		if (receiveUser == null) {
	...
	public static String spliceString(String email) {
		...
		String result = OoPassUtilities.getMD5(emailSplice);
		return result;
	}
